...
class TMSharedPreferences {
  static TMSharedPreferences? _singleton;
  static SharedPreferences? _store;

  static Future<TMSharedPreferences?> initialize() async {
    if (_singleton == null) {
      if (_singleton == null) {
        var singleton = TMSharedPreferences._();
